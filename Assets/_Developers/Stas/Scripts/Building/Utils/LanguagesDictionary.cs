...
namespace MythicalBattles.Assets._Developers.Stas.Scripts.Building.Utils
{
    ...
    {
        private static readonly Dictionary<string, string> _ruDomainDictionary = new()
        {
        ...
        private static readonly Dictionary<string, string> _enDomainDictionary = new()
        {
        ...
        private static readonly Dictionary<string, string> _trDomainDictionary = new()
        {
        ...
        public static string GetTranslation(string key)
        {
            ...
            {
                "ru" => _ruDomainDictionary.TryGetValue(key, out var ruValue) ? ruValue : key,
                "en" => _enDomainDictionary.TryGetValue(key, out var enValue) ? enValue : key,
                "tr" => _trDomainDictionary.TryGetValue(key, out var trValue) ? trValue : key,
